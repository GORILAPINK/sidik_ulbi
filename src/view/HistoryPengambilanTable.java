...
public class HistoryPengambilanTable extends JFrame {
    private static final long serialVersionUID = 1L;

    public HistoryPengambilanTable() {
        ...
        String[] kolom = {
            "ID Pengambilan", "Nama Pengambil", "NPM", "Jam", "Tanggal", "No Telp", "Jurusan", "Nama Barang", "ID Barang", "Gambar"
        };
        ...
        DefaultTableModel model = new DefaultTableModel(null, kolom) {
            ...
            public Class<?> getColumnClass(int column) {
                if (column == 10) return ImageIcon.class; // kolom gambar
                return Object.class;
            }
        };
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                int idPengambilan = rs.getInt("id_pengambilan");
                ...
                model.addRow(new Object[]{
                    idPengambilan, nama, npm, jam, tanggal, telp, jurusan, namaBarang, idBarang, icon
                });
            }
